...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func search(with term: String, offset: Int, searchOption: SearchOption, completion: @escaping ([Business]?, Error?) -> ()) -> AFHTTPRequestOperation {
        // For additional parameters, see http://www.yelp.com/developers/documentation/v2/search_api
        ...
        if searchOption.sort != nil {
            parameters["sort"] = searchOption.sort!.rawValue as AnyObject?
        }
        
        if searchOption.categories != nil && searchOption.categories!.count > 0 {
            parameters["category_filter"] = (searchOption.categories!).joined(separator: ",") as AnyObject?
        }
        if searchOption.distance != nil {
            parameters["radius_filter"] = searchOption.distance! as AnyObject?
        }
        
        if searchOption.deals != nil {
            parameters["deals_filter"] = searchOption.deals! as AnyObject?
        }
