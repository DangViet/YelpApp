...
class Business: NSObject {
    ...
    class func search(with term: String, offset: Int, searchOption: SearchOption, completion: @escaping ([Business]?, Error?) -> ()) {
        YelpClient.shared().search(with: term, offset:offset, searchOption:searchOption, completion: completion)
    }
}
